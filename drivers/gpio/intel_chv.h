...
#define CV_GPIO_NORTH_BASE		(CV_GPIO_SOUTHWEST_BASE + CV_NGPIO_SOUTHWEST)
...
#define CV_GPIO_NORTH_IRQBASE		(CV_GPIO_SOUTHWEST_IRQBASE + CV_NGPIO_SOUTHWEST)
#define CV_GPIO_EAST_IRQBASE		(CV_GPIO_NORTH_IRQBASE + CV_NGPIO_NORTH)
