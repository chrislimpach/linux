...
static struct thecus_board board_info [] = {
	...
	{ 7, "N4800Eco" , 4, 17, 1, "707", "BOARD_N2800", &n2800_func},
	{ 8, "N4510UPRO-R" , 4, 17, 1, "708", "BOARD_N5550", &n5550_func},
	{ 9, "N4510UPRO-S" , 4, 17, 1, "709", "BOARD_N5550", &n5550_func},
	{ }
};
...
static int proc_thecus_io_show(struct seq_file *m, void *v)
{
    ...
    if ((board_idx == 3) || (board_idx == 4) || (board_idx == 8)){
    ...
    if (board_idx == 1){
        ...
        seq_printf(m, "BAT_TMODE: Thermistor\n");
...
static void intrpt_routine(struct work_struct *unused)
{
    ...
    }else if ((board_idx == 3) || (board_idx == 4) || (board_idx == 8)){
	val = pca9532_id_get_input(4);
        if(psu1_status != val) {
            if(val == 1) {
    ...
    if ((board_idx == 4) || (board_idx == 5) || (board_idx == 8) || (board_idx == 9)) {
	val = pca9532_id_get_input(6);
        if(val == 0) {
