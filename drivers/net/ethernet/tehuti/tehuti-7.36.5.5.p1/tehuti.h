...
/* For kernels 2.6.24-3.3.0 */
#define BDX_DRV_VERSION	  "7.36.5.5"

#define DRIVER_AUTHOR	  "Tehuti Networks Ltd."
#define BDX_DRV_DESC	  "Tehuti Networks 10GbE Adapter Network Driver"
#define BDX_DRV_NAME	  "tehuti"
#define BDX_NIC_NAME	  "Tehuti Networks 10GbE Adapter"
#define BDX_NIC2PORT_NAME "Tehuti Networks 10GbE Adapter"
...
enum PHY_TYPE { 
	PHY_NA,      /* Port not exists */                            
	PHY_CX4,     /* PHY works without initialization */
	PHY_QT2025x, /* QT2025 10 Gbps XFP     */
	PHY_QT2025,  /* QT2025 10 Gbps SFP+    */
	PHY_TN8020,  /* TN8020  10baseT  */
PHY_CNT      
};
...
#define MDIO_CMD_STAT_VAL(rd_wrn, dev_addr, port_addr) \
    (((rd_wrn) << 2) | ((dev_addr) << 3) | ((port_addr) << 8))
